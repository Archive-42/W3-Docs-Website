!(() => {
  ...
  "fragmention" in window.location || (() => {
    ...
    document.addEventListener("DOMContentLoaded", () => {
      ...
      if (
        (Array.prototype.forEach.call(A, (e, n) => {
          e.addEventListener("click", () => {
            for (
              let n = document.querySelectorAll(".sharebox.open"), i = n.length - 1;
              i >= 0;
              i--
            )
              t(n[i], "open");
        ...
        document.addEventListener("click", e => {
          ...
          if (!i)
            for (
              let a = document.querySelectorAll(".sharebox.open"), r = a.length - 1;
              r >= 0;
              r--
            )
              t(a[r], "open");
    ...
    new Promise((e, n) => {
      ...
      function v() {
        if (-1 !== d && -1 !== u && -1 !== h && d === u && u === h) {
          if (null === a) {
            const t = /AppleWeb[kK]it\/([0-9]+)(?:\.([0-9]+))/.exec(
