! function () {
  ...
  "fragmention" in window.location || function () {
    function e( t, n ) {
    ...
    var n;
    "addEventListener" in window ? ( window.addEventListener( "hashchange", t ), document.addEventListener( "DOMContentLoaded", t ) ) : ( window.attachEvent( "onhashchange", t ), document.attachEvent( "onreadystatechange", function () {
      "c" === document.readyState[ 0 ] && t()
    } ) )
  }(), document.addEventListener( "DOMContentLoaded", function () {
    var i = ( document.createTextNode( " " ), document.querySelectorAll( ".content h2[id], .content h3[id], .content h4[id]" ) ),
      o = i[ 0 ];
    if ( o ) {
      e( o, "first" );
      var a = i,
      ...
      var l, d, u, h, f = document.createElement( "ul" ),
    ...
    if ( Array.prototype.forEach.call( A, function ( e, n ) {
        e.addEventListener( "click", function () {
          for ( var n = document.querySelectorAll( ".sharebox.open" ), i = n.length - 1; i >= 0; i-- ) t( n[ i ], "open" );
        ...
        for ( var i = !1, o = e.target; o != document.body; o = o.parentNode )
          ...
          for ( var a = document.querySelectorAll( ".sharebox.open" ), r = a.length - 1; r >= 0; r-- ) t( a[ r ], "open" )
...
function () {
  ...
  o.prototype.a = function ( n ) {
    n = n || "BESbswy";
    var o = "font-style:" + this.style + ";font-variant:" + this.variant + ";font-weight:" + this.weight + ";font-stretch:" + this.stretch + ";font-feature-settings:" + this.featureSettings + ";-moz-font-feature-settings:" + this.featureSettings + ";-webkit-font-feature-settings:" + this.featureSettings + ";",
      ...
      m = -1,
      w = this;
    return t( s, "sans-serif", o ), t( c, "serif", o ), t( l, "monospace", o ), r.appendChild( s.a ), r.appendChild( c.a ), r.appendChild( l.a ), document.body.appendChild( r ), f = s.a.offsetWidth, p = c.a.offsetWidth, m = l.a.offsetWidth, new Promise( function ( e, n ) {
      function b() {
      ...
      function v() {
        if ( -1 !== d && -1 !== u && -1 !== h && d === u && u === h ) {
          if ( null === a ) {
            var t = /AppleWeb[kK]it\/([0-9]+)(?:\.([0-9]+))/.exec( window.navigator.userAgent );
      ...
      setTimeout( function () {
        ...
        d = e, v()
      } ), t( s, w.family + ",sans-serif", o ), i( c, function ( e ) {
        u = e, v()
      } ), t( c, w.family + ",serif", o ), i( l, function ( e ) {
        h = e, v()
...
function ( e ) {
  if ( !( e.document.documentElement.className.indexOf( "vollkorn-loaded" ) > -1 ) ) {
    ...
    e.Promise.all( [ t.check(), n.check(), i.check(), o.check() ] ).then( function () {
