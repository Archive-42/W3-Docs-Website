...
if (
  ...
  function D(t, e, n) {
    for (
      let r, i = (ne[e] || []).concat(ne["*"]), o = 0, s = i.length;
      s > o;
      o++
    )
  ...
  (K.fn = K.prototype =
    {
      ...
      eq(t) {
        const e = this.length, n = +t + (0 > t ? e : 0);
  ...
  const it = (t => {
    ...
    function c(t) {
      return r(e => {
        return (e = +e),
        r((n, r) => {
          for (let i, o = t([], n.length, e), s = o.length; s--; )
            n[(i = o[s])] && (n[i] = !(r[i] = n[i]));
        });
      });
    }
    ...
    function d(t, e, n) {
      const r = e.dir, i = n && "parentNode" === r, o = Q++;
      return e.first
        ? (e, n, o) => {
    ...
    function b(t, n) {
      const i = n.length > 0,
            ...
            s = (r, s, a, l, c) => {
              ...
              const w = (U += null == y ? 1 : Math.random() || 0.1);
              const x = b.length;
    ...
    var tt = (t, e) => {
      for (let n = 0, r = t.length; r > n; n++) if (t[n] === e) return n;
      return -1;
    };
            ...
            return o;
              ...
              (L =
                e || mt.test(I.contains)
                  ? (t, e) => {
                      const n = 9 === t.nodeType ? t.documentElement : t, r = e && e.parentNode;
                      return (
                        t === r ||
                        !(
                          !r ||
      ...
      (T = e.selectors =
        {
          ...
          filter: {
            ...
            CHILD(t, e, n, r, i) {
              const o = "nth" !== t.slice(0, 3), s = "last" !== t.slice(-4), a = "of-type" === e;
              return 1 === r && 0 === i
                ? t => {
                    return !!t.parentNode;
                  }
              ...
              return o[H]
                ...
                ? ((i = [t, t, "", n]),
                  T.setFilters.hasOwnProperty(t.toLowerCase())
                    ? r((t, e) => {
                        for (let r, i = o(t, n), s = i.length; s--; )
          ...
          pseudos: {
            not: r(t => {
              const e = [], n = [], i = E(t.replace(lt, "$1"));
              return i[H]
                ? r((t, e, n, r) => {
                    for (let o, s = i(t, null, r, []), a = t.length; a--; )
                      (o = s[a]) && (t[a] = !(e[a] = o));
                  })
                : (t, r, o) => {
                    return (
  ...
  const pt = /^(?:parents|prev(?:Until|All))/, ht = { children: !0, contents: !0, next: !0, prev: !0 };
  K.extend({
    dir(t, e, n) {
  ...
  !(() => {
    const t = J.createDocumentFragment(), e = t.appendChild(J.createElement("div")), n = J.createElement("input");
  ...
  const Et = /^key/, At = /^(?:mouse|pointer|contextmenu)|click/, _t = /^(?:focusinfocus|focusoutblur)$/, $t = /^([^.]*)(?:\.(.+)|)$/;
  (K.event = {
    global: {},
    add(t, e, n, r, i) {
      let o;
    ...
    Y.focusinBubbles ||
      K.each({ focus: "focusin", blur: "focusout" }, (t, e) => {
        ...
        K.event.special[e] = {
          setup() {
            const r = this.ownerDocument || this, i = mt.access(r, e);
            i || r.addEventListener(t, n, !0), mt.access(r, e, (i || 0) + 1);
          },
          teardown() {
            const r = this.ownerDocument || this, i = mt.access(r, e) - 1;
            i
              ? mt.access(r, e, i)
  ...
  (Lt.optgroup = Lt.option),
    ...
    K.extend({
      ...
      cleanData(t) {
        for (
          let e, n, r, i, o = K.event.special, s = 0;
          void 0 !== (n = t[s]);
          s++
        ) {
          if (
    ...
    K.fn.extend({
      ...
      remove(t, e) {
        for (
          let n, r = t ? K.filter(t, this) : this, i = 0;
          null != (n = r[i]);
          i++
        )
  ...
  const Vt = { position: "absolute", visibility: "hidden", display: "block" };
  const Xt = { letterSpacing: "0", fontWeight: "400" };
  ...
  K.Animation = K.extend(q, {
    tweener(t, e) {
      ...
      for (let n, r = 0, i = t.length; i > r; r++)
        ...
        : this.each(
            K.isFunction(t)
              ...
              : function () {
                  if ("string" === n)
                    for (
                      let e, r = 0, i = K(this), o = t.match(dt) || [];
                      (e = o[r++]);
  ...
  (K.fn.load = function (t, e, n) {
    ...
    const s = this;
    const a = t.indexOf(" ");
    return a >= 0 && ((r = K.trim(t.slice(a))), (t = t.slice(0, a))),
    K.isFunction(e)
      ? ((n = e), (e = void 0))
  ...
  (K.offset = {
    ...
    K.each({ Height: "height", Width: "width" }, (t, e) => {
      K.each(
        ...
        (n, r) => {
          K.fn[r] = function (r, i) {
            const o = arguments.length && (n || "boolean" != typeof r), s = n || (r === !0 || i === !0 ? "margin" : "border");
            return vt(
              this,
              (e, n, r) => {
                let i;
...
;
  ...
  !((t, e) => {
    ...
    /*! svg4everybody v2.0.0 | github.com/jonathantneal/svg4everybody */ function t(
      ...
      if (e) {
        const n = !t.getAttribute("viewBox") && e.getAttribute("viewBox"), r = document.createDocumentFragment(), i = e.cloneNode(!0);
...
+(t => {
  ...
  (n.VERSION = "3.3.2"),
    ...
    (n.prototype.setState = function (e) {
      const n = "disabled", r = this.$element, i = r.is("input") ? "val" : "html", o = r.data();
      (e += "Text"),
  ...
  (n.VERSION = "3.3.2"),
    ...
    (n.prototype.getItemForDirection = function (t, e) {
      ...
      const i = "prev" == t ? -1 : 1, o = (n + i) % this.$items.length;
    ...
    (n.prototype.slide = function (e, r) {
      const i = this.$element.find(".item.active"), o = r || this.getItemForDirection(e, i), s = this.interval, a = "next" == e ? "left" : "right", l = this;
      if (o.hasClass("active")) return (this.sliding = !1);
      const c = o[0], u = t.Event("slide.bs.carousel", { relatedTarget: c, direction: a });
  ...
  const i = function (n) {
    ...
    if (o.hasClass("carousel")) {
      const s = t.extend({}, o.data(), i.data()), a = i.attr("data-slide-to");
      a && (s.interval = !1),
        e.call(o, s),
  ...
  (t.fn.collapse = n),
    ...
    t(document).on(
      ...
      function (r) {
        ...
        const o = e(i), s = o.data("bs.collapse"), a = s ? "toggle" : t.extend({}, i.data(), { trigger: this });
        n.call(o, a);
      }
    );
})(jQuery), +(t => {
  ...
  function e(e) {
    (e && 3 === e.which) ||
      (t(i).remove(),
      t(o).each(function () {
        const r = t(this), i = n(r), o = { relatedTarget: this };
        i.hasClass("open") &&
    ...
    (s.prototype.keydown = function (e) {
      if (
        ...
        if (
          ...
          const i = n(r), s = i.hasClass("open");
          if ((!s && 27 != e.which) || (s && 27 == e.which))
            return (
              27 == e.which && i.find(o).trigger("focus"), r.trigger("click")
            );
          const a = " li:not(.divider):visible a", l = i.find('[role="menu"]' + a + ', [role="listbox"]' + a);
          if (l.length) {
  ...
  (n.VERSION = "3.3.2"),
    ...
    (n.prototype.show = function (e) {
      const r = this, i = t.Event("show.bs.modal", { relatedTarget: e });
        ...
        this.isShown ||
          ...
          this.backdrop(() => {
            ...
            r.$element.parent().length || r.$element.appendTo(r.$body),
              ...
              r.enforceFocus();
            const o = t.Event("shown.bs.modal", { relatedTarget: e });
            i
              ? r.$element
                  .find(".modal-dialog")
                  .one("bsTransitionEnd", () => {
    ...
    (n.prototype.backdrop = function (e) {
      const r = this, i = this.$element.hasClass("fade") ? "fade" : "";
    ...
    t(document).on(
      ...
      function (n) {
        ...
        r.is("a") && n.preventDefault(),
          o.one("show.bs.modal", t => {
            t.isDefaultPrevented() ||
              o.one("hidden.bs.modal", () => {
  ...
  (n.VERSION = "3.3.2"),
    ...
    (n.prototype.init = function (e, n, r) {
      ...
      for (let i = this.options.trigger.split(" "), o = i.length; o--; ) {
        ...
        if ("click" == s)
          ...
          const a = "hover" == s ? "mouseenter" : "focusin", l = "hover" == s ? "mouseleave" : "focusout";
          this.$element.on(
            a + "." + this.type,
            this.options.selector,
    ...
    (n.prototype.getDelegateOptions = function () {
      const e = {}, n = this.getDefaults();
      return this._options &&
        t.each(this._options, (t, r) => {
          n[t] != r && (e[t] = r);
        }),
      e
    ;
    ...
    (n.prototype.show = function () {
      ...
      if (this.hasContent() && this.enabled) {
        ...
        const i = this, o = this.tip(), s = this.getUID(this.type);
        this.setContent(),
          o.attr("id", s),
        ...
        const u = this.getPosition(), p = o[0].offsetWidth, h = o[0].offsetHeight;
        if (c) {
          const d = a,
    ...
    isNaN(s) && (s = 0),
      ...
      r.addClass("in");
    const l = r[0].offsetWidth, c = r[0].offsetHeight;
    "top" == n && c != o && (e.top = e.top + o - c);
    const u = this.getViewportAdjustedDelta(n, e, l, c);
    u.left ? (e.left += u.left) : (e.top += u.top);
    const p = /top|bottom/.test(n), h = p ? 2 * u.left - i + l : 2 * u.top - o + c, d = p ? "offsetWidth" : "offsetHeight";
    ...
    (n.prototype.setContent = function () {
      const t = this.tip(), e = this.getTitle();
    ...
    const o = r ? { top: 0, left: 0 } : e.offset(),
          s = {
            scroll: r
    ...
    (n.prototype.getViewportAdjustedDelta = function (t, e, n, r) {
      ...
      const o = (this.options.viewport && this.options.viewport.padding) || 0, s = this.getPosition(this.$viewport);
      if (/right|left/.test(t)) {
        const a = e.top - o - s.scroll, l = e.top + o - s.scroll + r;
        a < s.top
          ? (i.top = s.top - a)
          : l > s.top + s.height && (i.top = s.top + s.height - l);
      } else {
        const c = e.left - o, u = e.left + o + n;
        c < s.left
          ? (i.left = s.left - c)
  ...
  (n.VERSION = "3.3.2"),
    ...
    (n.prototype.setContent = function () {
      const t = this.tip(), e = this.getTitle(), n = this.getContent();
    ...
    (n.prototype.getContent = function () {
      const t = this.$element, e = this.options;
      return (
        t.attr("data-content") ||
  ...
  (e.VERSION = "3.3.2"),
    ...
    (e.prototype.refresh = function () {
      ...
      this.$body
        .find(this.selector)
        .map(function () {
          const r = t(this), i = r.data("target") || r.attr("href"), o = /^#./.test(i) && t(i);
          return (
  ...
  (n.VERSION = "3.3.2"),
    ...
    if (
      ...
      const i = n.find(".active:last a"), o = t.Event("hide.bs.tab", { relatedTarget: e[0] }), s = t.Event("show.bs.tab", { relatedTarget: i[0] });
      if (
        (i.trigger(o),
        e.trigger(s),
  ...
  (n.VERSION = "3.3.2"),
    ...
    (n.prototype.getState = function (t, e, n, r) {
      const i = this.$target.scrollTop(), o = this.$element.offset(), s = this.$target.height();
      if (null != n && "top" == this.affixed) return i < n && "top";
      if ("bottom" == this.affixed)
        return null != n
          ? !(i + this.unpin <= o.top) && "bottom"
          : !(i + s <= t - r) && "bottom";
      const a = null == this.affixed, l = a ? i : o.top, c = a ? s : e;
      return null != n && i <= n
        ? "top"
    ...
    (n.prototype.getPinnedOffset = function () {
      ...
      const t = this.$target.scrollTop(), e = this.$element.offset();
    ...
    (n.prototype.checkPosition = function () {
      if (this.$element.is(":visible")) {
        ...
        if (this.affixed != a) {
          ...
          const l = "affix" + (a ? "-" + a : ""), c = t.Event(l + ".bs.affix");
...
})(jQuery) /*! URI.js v1.15.1 http://medialize.github.io/URI.js/ */, ((t, e) => {
  "object" == typeof exports
    ? (module.exports = e(
        require("./punycode"),
        require("./IPv6"),
  ...
  function i(t, e) {
    const n = 1 <= arguments.length, r = 2 <= arguments.length;
  ...
  const g = r && r.URI;
  i.version = "1.15.1";
  const v = i.prototype, m = Object.prototype.hasOwnProperty;
  (i._parts = () => {
    return {
      protocol: null,
      username: null,
  ...
  let y;
  let b = { encode: "encode", decode: "decode" };
  ...
  (b = (t, e, n) => {
    ...
    (i.withinString = (t, e, n) => {
      n || (n = {});
      const r = n.start || i.findUri.start, o = n.end || i.findUri.end, s = n.trim || i.findUri.trim, a = /[a-z0-9-]=["']?$/i;
      for (r.lastIndex = 0; ; ) {
        let l = r.exec(t);
        if (!l) break;
    ...
    (v.href = function (t, e) {
      ...
      let r = t instanceof i, o = "object" == typeof t && (t.hostname || t.path || t.pathname);
      if (
        (t.nodeName &&
    ...
    (v.is = function (t) {
      let e = !1, r = !1, o = !1, s = !1, a = !1, l = !1, c = !1, u = !this._parts.urn;
      switch (
  ...
  const x = v.protocol, T = v.port, C = v.hostname;
  ...
  return (v.query = function (t, e) {
    ...
    if ("function" == typeof t) {
      const n = i.parseQuery(this._parts.query, this._parts.escapeQuerySpace), r = t.call(this, n);
      return (
 ...
 */, (t => {
  ...
  function s(t, n) {
    const r = ("" + ("string" == typeof t ? t : t.type)).replace(/^on/, ""), o = z[r];
    if (o) {
  ...
  var O = v[j];
  var R = v[I];
  var P = { basepath: "/", redirect: 0, type: "/", init: 0 };
  ...
  var z = {};
  let V = m.title;
  const X = { onhashchange: f, onpopstate: f };
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  Array.prototype.forEach.call(o, (o, s) => {
    const a = t.cloneNode(!0), l = o.parentNode.parentNode.id;
    ...
    const c = r.replace("%s", i + "#" + l).replace("%s", i + "#" + l), u = n.cloneNode(!0);
    u.innerHTML = c;
    const p = e.cloneNode(!0);
    p.appendChild(a),
      p.appendChild(u),
      a.addEventListener("click", function (t) {
        const e = this.nextSibling, n = e.querySelector("input");
        hasclass(e, "open")
          ? remclass(e, "open")
  ...
  Array.prototype.forEach.call(s, (t, e) => {
    t.addEventListener("click", () => {
      for (
        let e = document.querySelectorAll(".sharebox.open"), n = e.length - 1;
        n >= 0;
        n--
      )
        remclass(e[n], "open");
  ...
  jQuery(document).ready(t => {
    ...
    function i() {
      const e = window.history.location || window.location, n = new URI(e), r = n.search(!0);
      if (
        (r.hidesidebar &&
          (t(".sidebar").hide(),
    ...
    function o() {
      const e = t("#tags .btn-primary:not(:disabled)"), n = t("#audiences input:checked"), r = t("#filter-levels input:not(:checked)");
      if (e.length > 0) {
        const i = [], o = [], s = [];
        e.each((e, n) => {
    ...
    function s() {
      ...
      const e = [], n = t("#filter-technologies input:not(:checked)");
      if (n.length > 0) {
        n.each((n, r) => {
          e.push(t(r).val());
        });
    ...
    function c() {
      const e = window.history.location || window.location, n = new URI(e), i = [];
      n.removeSearch("tags"),
        t("#tags .btn-primary").each((e, r) => {
    ...
    function p(e) {
      ...
      const i = new URI(n);
      let o = 60;
      return t(".navrow").outerHeight() > 0 && (o = t(".navrow").outerHeight() + 5),
      setTimeout(() => {
    ...
    function d() {
      t("html").addClass("has-js"),
        ...
        t("#hidesidebars").on("click", () => {
          const e = window.history.location || window.location, n = new URI(e);
        ...
        t("#navtabs a").on("click", function (e) {
          const n = window.history.location || window.location, i = new URI(n);
    ...
    var f = () => {
      ...
      "2.1only" == h
        ...
        : (version = "WCAG " + h + ":");
      const d = t("#filter-techniques-content input"), f = d.filter(":checked");
    ...
    t("#tags").on("click", ".btn", e => {
      ...
      t("main").on("change", ".techniques-button input", e => {
        e.preventDefault();
        const n = t(e.target), r = n.attr("name").match(/sc-[0-9]{2,3}-(.*)/)[1];
      ...
      t("main").on("click", ".techniques-button .btn-techniques", e => {
        const n = t(e.target), i = n.attr("aria-controls"), o = window.history.location || window.location, s = new URI(o), a = [];
        if (
          (t('.btn-techniques[aria-expanded="true"]').each((e, n) => {
      ...
      t("#sharethisviewbutton").on("click", function () {
        const e = window.history.location || window.location, n = t(this).parent().find(".sharebox");
        n.hasClass("open")
          ? n.removeClass("open")
