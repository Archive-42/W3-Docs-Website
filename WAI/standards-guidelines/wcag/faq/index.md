...
-   [FAQ](/WAI/standards-guidelines/wcag/faq/)
...
This page answers to some frequently asked questions (FAQ) about Web Content Accessibility Guidelines (WCAG). Let us know what [other questions](#more) you have.  
~*[Shawn Henry](http://w3.org/People/Shawn/)*, W3C WAI, *updated 21 January 2021*
...
-   [Does WCAG address mobile accessibility?](#mobile)
...
There are 17 additional success criteria in 2.1 that are not in 2.0. They are introduced in [What’s New in WCAG 2.1](/WAI/standards-guidelines/wcag/new-in-21/).
...
**Yes.** See the [Mobile Accessibility at W3C](/WAI/standards-guidelines/mobile/) page.

Does VPAT 2.1 include WCAG 2.1?
-------------------------------
...
If you want a really short introduction to 3 web accessibility issues (alternative text for images, keyboard input, and transcripts), see [Examples of Web Accessibility](/WAI/fundamentals/accessibility-intro/#examples).
...
**To learn about WCAG 2 specifically, start with the [WCAG Overview](/WAI/standards-guidelines/wcag/).** It provides an important foundation for understanding the different WCAG 2 documents, and points to several resources for using WCAG 2.
...
To learn how the different WCAG 2 technical documents are related and linked, see [WCAG 2 Documents](/WAI/standards-guidelines/wcag/docs/).
...
**For supporting resources that provide practical advice for meeting ISO/IEC 40500 (which is WCAG 2.0), see the [WCAG Overview](/WAI/standards-guidelines/wcag/).**
...
W3C has offered our [WCAG 2.0 Authorized Translations](/WAI/standards-guidelines/wcag/translations/) to be used for the ISO/IEC translations. We will update this page when more information about translations is available.

Is WCAG 2 available in other languages?
---------------------------------------

**Yes.** Authorized Translations and unofficial translations of the technical documents WCAG 2, Techniques for WCAG 2, and Understanding WCAG 2 are listed in [WCAG 2 Translations](/WAI/standards-guidelines/wcag/translations/).
...
For more information on how you can contribute to WAI translations, see [Translating WAI Resources](/WAI/about/translating/).

Can I meet WCAG 2 with Javascript/Ajax, Silverlight, and other technologies?
----------------------------------------------------------------------------
...
-   Join the self-subscription list and post an appropriate question. Please read the [Using the WAI IG mailing list](/WAI/about/groups/waiig/#mailinglist) section of the WAI IG page.
...
Please share your ideas, suggestions, or comments via e-mail to the publicly-archived list [wai-eo-editors@w3.org](mailto:wai-eo-editors@w3.org?subject=%5Ben%5D%20WCAG%202%20FAQ) or via GitHub.

<a href="mailto:wai-eo-editors@w3.org?subject=%5Ben%5D%20WCAG%202%20FAQ&amp;body=%5Bput%20comment%20here...%5D" class="button"><span>E-mail</span></a> <a href="https://github.com/w3c/wai-intro-wcag/edit/master/content/faq.md" class="button"><span>Fork &amp; Edit on GitHub</span></a><a href="https://github.com/w3c/wai-intro-wcag/issues/new" class="button"><span>New GitHub Issue</span></a>

Back to Top

**Date:** Updated 21 January 2021. First published October 2006.
