          ...
          if (c != 0) {
            ...
            for (var i = 0; i < found.length; i++) {
              if (l_o >= start && l_o < set.show + start) {
                ...
                if (set.debug) {
                  out +=
                    '<p class="tipue_search_content_debug">Score: ' +
                    found[i].score +
                    "</p>";
                }
                ...
                if (set.showURL) {
                  ...
                  out +=
                    '<p class="tipue_search_content_url"><a href="' +
                    found[i].url +
                    '"' +
                    tipue_search_w +
                    ">" +
                ...
                if (found[i].desc) {
                  ...
                  out +=
                    '<p class="tipue_search_content_text">' + t_d + "</p></li>";
                }
              }
              l_o++;
            }
            ...
            if (c > set.show) {
              ...
              out +=
                '<footer><nav class="pagination" aria-label="pagination"><ul>';

              if (start > 0) {
                out +=
                  '<li><button class="tipue_search_foot_box" id="' +
                  (start - set.show) +
                  "_" +
                  replace +
                  '">' +
