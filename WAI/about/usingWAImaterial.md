...
-   [Using WAI Material](/WAI/about/using-wai-material/)
...
-   <a href="#official-w3c-document-license" id="markdown-toc-official-w3c-document-license">Official W3C Document License</a>
-   <a href="#cc" id="markdown-toc-cc">Creative Commons Licensed (CC) Material for You to Adapt</a>
-   <a href="#finding-which-type-of-license" id="markdown-toc-finding-which-type-of-license">Finding Which Type of License</a>
-   <a href="#let-us-know" id="markdown-toc-let-us-know">Let Us Know</a>
-   <a href="#appropriate-use" id="markdown-toc-appropriate-use">Appropriate Use</a>
...
2.  You **clearly attribute the material** appropriately.  
    ...
    > Some information in this article is from the Web Accessibility Initiative ([WAI](https://www.w3.org/WAI/)) document: [Developing Web Accessibility Presentations and Training](https://www.w3.org/WAI/training/). Andrew Arch and Shadi Abou-Zahra, eds. Copyright © 2010 [W3C](http://www.w3.org/)® ([MIT](https://www.csail.mit.edu/), [ERCIM](http://www.ercim.eu/), [Keio](https://www.keio.ac.jp/)). Status: Draft Updated 16 September 2010. <https://www.w3.org/WAI/training/>
...
[Referencing and Linking to WAI Guidelines and Technical Documents](/WAI/standards-guidelines/linking/) provides general guidance for links, along with which [WCAG links](/WAI/standards-guidelines/linking/#wcag) to use for policies, tools support, and others.
...
Please share your ideas, suggestions, or comments via e-mail to the publicly-archived list [wai-eo-editors@w3.org](mailto:wai-eo-editors@w3.org?subject=%5Ben%5D%20Using%20WAI%20Material:%20Permission%20to%20Use%20with%20Attribution) or via GitHub.

<a href="mailto:wai-eo-editors@w3.org?subject=%5Ben%5D%20Using%20WAI%20Material:%20Permission%20to%20Use%20with%20Attribution&amp;body=%5Bput%20comment%20here...%5D" class="button"><span>E-mail</span></a> <a href="https://github.com/w3c/wai-about-wai/edit/master/_about/using-wai-material.md" class="button"><span>Fork &amp; Edit on GitHub</span></a><a href="https://github.com/w3c/wai-about-wai/issues/new" class="button"><span>New GitHub Issue</span></a>
...
Developed with the [WAI staff](http://www.w3.org/People/domain?domain=Web+Accessibility+Initiative) and [W3C Communications staff](https://www.w3.org/People/functions/comm).
