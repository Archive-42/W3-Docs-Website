window.Modernizr = function ( e, t, n ) {
  ...
  f = a( j, "undefined" ) || a( j.call, "undefined" ) ? (e, t) => {
  ...
  for ( const D in x ) f( x, D ) && ( s = D.toLowerCase(), d[ s ] = x[ D ](), T.push( ( d[ s ] ? "" : "no-" ) + s ) );
  return d.input || u(), d.addTest = (e, t) => {
      if ( "object" == typeof e )
        for ( const r in e ) f( e, r ) && d.addTest( r, e[ r ] );
      else {
    ...
    function c( e, t ) {
      t.cache || ( t.cache = {}, t.createElem = e.createElement, t.createFrag = e.createDocumentFragment, t.frag = t.createFrag() ), e.createElement = n => {
        return y.shivMethods ? o( n, e, t ) : t.createElem( n )
      }, e.createDocumentFragment = Function( "h,f", "return function(){var n=f.cloneNode(),c=n.createElement;h.shivMethods&&(" + r().join().replace( /[\w\-]+/g, e => {
    ...
    !(() => {
      try {
        ...
        e.innerHTML = "<xyz></xyz>", u = "hidden" in e, s = 1 == e.childNodes.length || (() => {
          t.createElement( "a" );
  ...
  function d( e ) {
    ...
    return !C || e.printShived ? e : ( "undefined" == typeof c[ x ] && c.add( x ), l.attachEvent( "onbeforeprint", () => {
      t();
  ...
  var y = /^<|^(?:a|b|button|code|div|fieldset|form|h1|h2|h3|h4|h5|h6|i|iframe|img|input|label|li|link|ol|option|p|param|q|script|select|span|strong|style|table|tbody|td|textarea|tfoot|th|thead|tr|ul)$/i;
  var E = "_html5shiv";
  var b = 0;
  var S = {};
  !(() => {
